      ...
      <p
        className={
          isError
            ...
            : "error-message text-center d-none"
        }
      >
        it seems like we had a problem getting your ubication, check the
        permissions clicking <i class="fas fa-map-marker-alt"></i> in your
        navigator
      </p>
    </div>
  );
